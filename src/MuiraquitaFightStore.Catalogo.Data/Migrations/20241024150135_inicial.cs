        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TamanhoNumeracao = table.Column<string>(type: "Varchar(100)", nullable: true),
                    TamanhoCamisa = table.Column<string>(type: "Varchar(100)", nullable: true),
                    TamanhoShort = table.Column<string>(type: "Varchar(100)", nullable: true),
                    Peso = table.Column<string>(type: "Varchar(3)", nullable: true)
                },
                constraints: table =>
                {
